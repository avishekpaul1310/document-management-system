...
from ..forms import ShareDocumentForm  # We'll create this next
...
class ShareDocumentView(LoginRequiredMixin, UserPassesTestMixin, CreateView):
    ...
    def get_form_kwargs(self):
        ...
        kwargs['document'] = get_object_or_404(Document, pk=self.kwargs['pk'])
    ...
    def form_valid(self, form):
        form.instance.document = get_object_or_404(Document, pk=self.kwargs['pk'])
